...
partial class Build
{
    ...
    .Executes(() =>
    {
        var aipProjectPath = Path.Combine(RootDirectory, @"Installer\ScaleBars.aip");
        var version = Solution.ScaleBars.GetProperty("Version");
    ...
    {
        var aipOutputPath = Path.Combine(RootDirectory, @"Installer\ScaleBars-SetupFiles");
